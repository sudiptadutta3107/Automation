...
namespace Automation
{
    ...
    {
        static ZcadApplication mApp;
        static ZcadDocument mDoc;        
        static ZcadModelSpace mSpace;
        ...
        { 
            ...
            myline = mSpace.AddLine(startpoint, endpoint);
            myline.Update();
            mApp.ZoomExtents();
        }
        static void Main()
        ...
        {
            mApp = (ZcadApplication)Marshal.GetActiveObject("ZWCAD.Application.2025");
            mDoc = mApp.ActiveDocument;
            mSpace = mDoc.ModelSpace;
            mApp.Visible = true;
        }
    }
}
